...
impl<const COMPRESSED: bool> Scanning<OpenJDK<COMPRESSED>> for VMScanning {
    ...
    fn single_threaded_scan_vm_specific_roots(
        ...
        single_threaded_scan_code_cache_roots::<COMPRESSED>(&mut closure);
    }
...
#[cfg(feature = "single_worker")]
fn single_threaded_scan_code_cache_roots<const COMPRESSED: bool>(
    closure: &mut impl ObjectGraphTraversal<OpenJDKSlot<COMPRESSED>>,
) {
